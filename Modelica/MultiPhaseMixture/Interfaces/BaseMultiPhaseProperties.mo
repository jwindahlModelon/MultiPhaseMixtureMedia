...
partial model BaseMultiPhaseProperties
  //-----------Phase properties--------------//
...
//  Integer presentPhaseIndex[nP]; //stop search when presentPhaseIndex[i] < 0 or i==nP
  Real presentPhaseIndex[nP]; //stop search when presentPhaseIndex[i] < 0 or i==nP
  Modelica.SIunits.MassFraction phaseComposition[nP*nC]
