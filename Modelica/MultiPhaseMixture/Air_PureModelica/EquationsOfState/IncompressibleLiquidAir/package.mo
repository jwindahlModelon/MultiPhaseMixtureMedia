...
package IncompressibleLiquidAir "Incompressible model of liquid air"
  ...
  "If true, an analytic inverse is available to compute temperature, given specific enthalpy";
   ...
   constant
  MultiPhaseMixture.Air_PureModelica.EquationsOfState.Data.LinearFluid data=Data.Liquidairdata;
  constant
  MultiPhaseMixture.Air_PureModelica.EquationsOfState.Data.ValidityLimits limits(
  DMIN=960,
  DMAX=1010,
  TMIN=275,
  TMAX=370,
